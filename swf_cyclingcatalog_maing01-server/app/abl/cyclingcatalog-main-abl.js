...
const Errors = require("../api/errors/cyclingcatalog-main-error.js");
...
class CyclingcatalogMainAbl {
  ...
  async init(awid, dtoIn) {
    ...
    // HDS 2
    const schemas = ["cyclingcatalogMain"];
...
module.exports = new CyclingcatalogMainAbl();
